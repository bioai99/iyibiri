...
- 2026-04-25 | 2026-04-25-odul-sistemi-derin-arastirma → **Ödül sistemi 4 boyutlu tam analiz tamamlandı.** Firma tarafı (sponsor CSR KPI driven, ₺1–3M/sponsor), kullanıcı (TR kültür + SDT motivasyon tipi), regülasyon (4 yasal çerçeve, kupon=🟢 güvenli, nakit=🔴 taboo), benchmark (Charity Miles + Duolingo + Strava). V2 mimarisi: Tier-based katalog (Bronz–Elmas), 4 ödül tipi (kupon/match/badge/deneyim), sponsor onboarding 5-adım, aylık/monthly/quarterly dashboard. Pilot: Migros + Garanti (Ay 4–8 satış). 7 Powers moat: orta (4/7 aktif). Avukat 5 soru + 5 açık karar. Analyst handoff hazır.
